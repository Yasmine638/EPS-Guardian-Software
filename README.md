...
This test will constitute the final demonstration for the **IEEE AESS & IES Challenge 2025**, showcasing a fully functional hybrid AI EPS monitoring system combining both software and hardware components.

>  The **hardware implementation** of this system is developed and documented separately in the companion repository:  
>  [EPS-Guardian-Hardware](https://github.com/Yasmine638/EPS-Guardian-Hardware)
